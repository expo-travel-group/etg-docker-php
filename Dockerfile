...
RUN apk add --update --no-cache php php-zip php-bcmath php-gd php-memcached php-mysqli php-xsl php-ldap php-curl php-mbstring php-json php-phar php-sqlite3 php-pdo php-ctype
